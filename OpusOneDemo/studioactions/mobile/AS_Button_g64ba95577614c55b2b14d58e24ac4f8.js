function AS_Button_g64ba95577614c55b2b14d58e24ac4f8(eventobject) {
    var self = this;
    if (voltmx.theme.getCurrentTheme() != "default") {
        voltmx.theme.setCurrentTheme("default", function() {
            self.view.lblHome.skin = "FooterNameSkinHighlight";
        }, null);
    } else {
        (function() {
            self.view.lblHome.skin = "FooterNameSkinHighlight";
    ...
    self.view.ImgHome.src = "favorites_active.png";
